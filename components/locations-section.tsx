          ...
          <div>
            <div className="mb-6">
              ...
              <p className="text-gray-300 dark:text-gray-300 text-base leading-relaxed mb-6 max-w-md">
                Our state-of-the-art facility in Burlington, Ontario offers world-class sports facilities including squash courts, table tennis tables, and chess areas. Visit us to experience premium athletic training and competition spaces.
              </p>
